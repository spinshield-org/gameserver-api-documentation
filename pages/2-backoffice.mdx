...
## Overview
Within overview you can check your current balance, which is applicable to you if you have a GGR% based contract. The balance controls the due amount you can have in current billing cycle.
...
## Provider Stats
In this overview you can view all revenue stats per provider on your current billing cycle.

[![](screenshots/backoffice/provider-stats.png)]()
