...
You should always check if player's balance is the same or greater then the `balance_required` variable. If it is not, you should return the insufficient balance response (error: 1) like shown below.
