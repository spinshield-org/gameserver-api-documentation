...
### Free Round Spin Callback Request
This callback is sent when player is playing on gifted free rounds, which added with the [addFreeRounds method](/api-methods/add-freerounds).
