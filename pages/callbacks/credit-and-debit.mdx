...
When this variable is `1` it means the sent action is a rollback. The original round_id should be included and you should proceed to either `debit` or `credit` the player's balance like normal.
