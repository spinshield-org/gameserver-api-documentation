...
For more details check out details about the [package on github](https://github.com/spinshield/spinclient) or run `composer require spinshield/spinclient` to get started.
