...
| :------------ | :---------: | ----------: |
| #1        |    createPlayer    | [action](/i-methods/create-player) |
| #2        |    getGame    | [action](/i-methods/get-game) |

### Opening New Demo Game Session
| Order        | API Method |   Documentation |
| :------------ | :---------: | ----------: |
| #1        |    getGameDemo    | [action](/i-methods/get-game-demo) |

### Opening New Free Spins Bonus Game Session
| Order        | API Method |   Documentation |
| :------------ | :---------: | ----------: |
| #1        |    createPlayer    | [action](/i-methods/create-player) |
| #2        |    addFreeRounds    | [action](/i-methods/add-freerounds) |
| #3        |    getGame    | [action](/i-methods/get-game) |
