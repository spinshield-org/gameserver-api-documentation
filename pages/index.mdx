...
## Default API Sequences

### Opening New Real Game Session
| Order        | API Method |   Documentation |
| :------------ | :---------: | ----------: |
| #1        |    createPlayer    | [action](/api-methods/create-player) |
| #2        |    getGame    | [action](/api-methods/get-game) |

### Opening New Demo Game Session
| Order        | API Method |   Documentation |
| :------------ | :---------: | ----------: |
| #1        |    getGameDemo    | [action](/api-methods/get-game-demo) |

### Opening New Free Spins Bonus Game Session
| Order        | API Method |   Documentation |
| :------------ | :---------: | ----------: |
| #1        |    createPlayer    | [action](/api-methods/create-player) |
| #2        |    addFreeRounds    | [action](/api-methods/add-freerounds) |
| #3        |    getGame    | [action](/api-methods/get-game) |
